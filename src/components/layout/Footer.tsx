        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="animate-fade-in-up">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Empowering businesses through innovative IT solutions and managed
              services.
            </p>
            {/* Social Media Links */}
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-cyan-500 transition-colors duration-300"
                aria-label="Facebook"
              >
                <svg
                  className="w-5 h-5"
              ...
              <a
                href="https://www.linkedin.com/company/invade-tech-solutions/about/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-cyan-500 transition-colors duration-300"
                aria-label="LinkedIn"
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <a
                  href="mailto:info@invadetech.com"
