...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 border-t border-gray-800 overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/share/1FLJ62ZZCV/?mibextid=wwXIfr"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/invade_tech?igsh=MW56ejg0eHFpZ3dpdA%3D%3D&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-cyan-500 transition-colors"
              >
              ...
              <a
                href="https://www.linkedin.com/company/invade-tech-solutions/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-cyan-500 transition-colors"
              >
